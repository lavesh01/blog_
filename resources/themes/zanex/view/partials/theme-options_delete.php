                        ...
                        <!--<li class="theme-settings-swatches d-none list-group-item">
                            ...
                            <div class="swatch-holder swatch-holder-img active">
                                <a class="img-holder switch-trigger">
                                    <img alt=" " src="<?=base_url()?>resources/themes/zanex/assets/images/sidebar/city1.jpg">
                                </a>
                            </div>
                            <div class="swatch-holder swatch-holder-img">
                                <a class="img-holder switch-trigger">
                                    <img alt=" " src="<?=base_url()?>resources/themes/zanex/assets/images/sidebar/city2.jpg">
                                </a>
                            </div>
                            <div class="swatch-holder swatch-holder-img">
                                <a class="img-holder switch-trigger">
                                    <img alt=" " src="<?=base_url()?>resources/themes/zanex/assets/images/sidebar/city3.jpg">
                                </a>
                            </div>
                            <div class="swatch-holder swatch-holder-img">
                                <a class="img-holder switch-trigger">
                                    <img alt=" " src="<?=base_url()?>resources/themes/zanex/assets/images/sidebar/city4.jpg">
                                </a>
                            </div>
                            <div class="swatch-holder swatch-holder-img">
                                <a class="img-holder switch-trigger">
                                    <img alt=" " src="<?=base_url()?>resources/themes/zanex/assets/images/sidebar/city5.jpg">
                                </a>
                            </div>
                            <div class="swatch-holder swatch-holder-img">
                                <a class="img-holder switch-trigger">
                                    <img alt=" " src="<?=base_url()?>resources/themes/zanex/assets/images/sidebar/abstract1.jpg">
                                </a>
                            </div>
                            <div class="swatch-holder swatch-holder-img">
                                <a class="img-holder switch-trigger">
                                    <img alt=" " src="<?=base_url()?>resources/themes/zanex/assets/images/sidebar/abstract2.jpg">
                                </a>
                            </div>
                            <div class="swatch-holder swatch-holder-img">
                                <a class="img-holder switch-trigger">
                                    <img alt=" " src="<?=base_url()?>resources/themes/zanex/assets/images/sidebar/abstract3.jpg">
                                </a>
                            </div>
                            <div class="swatch-holder swatch-holder-img">
                                <a class="img-holder switch-trigger">
                                    <img alt=" " src="<?=base_url()?>resources/themes/zanex/assets/images/sidebar/abstract4.jpg">
                                </a>
                            </div>
                            <div class="swatch-holder swatch-holder-img">
                                <a class="img-holder switch-trigger">
                                    <img alt=" " src="<?=base_url()?>resources/themes/zanex/assets/images/sidebar/abstract5.jpg">
                                </a>
                            </div>
                        </li>-->
                    </ul>
