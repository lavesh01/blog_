...
(function () {
  this.jKanban = function () {
    ...
    var item,title,notes, enddate,created_on ;
    ...
    if (item.notes !== undefined && item.notes != '' && item.notes !=  null  ) {
      notes = item.notes;
    }
    ...
    if (item.created_on !== undefined && item.created_on != '' && item.created_on !=  null  ) {
    ...
    var strhtm =   ` <div class="widget-content">
                                    <div class="widget-content-outer">
                                        <div class="widget-content-wrapper mb-1">
                                            <div class="widget-content-left">
                                                <div class="widget-subheading"><i data-toggle="tooltip" data-title="Title" class="fa fa-at icon-gradient bg-night-fade" ></i>  `+ title +`</div>
                                                <div class="widget-subheading"><i data-toggle="tooltip" data-title="Notes" class="fa fa-ils icon-gradient bg-malibu-beach" ></i> `+ notes +`</div>
                                        ...
                                        <div class="widget-progress-wrapper sub_profile">
                                           ...
                                           `+strtag+`
                                            <div class="progress-sub-label  mb-1">
                                                <div class="sub-label-left font-icon-lg" ><i data-toggle="tooltip" data-title="Date Created" class="fa fa-clock-o icon-gradient bg-premium-dark" ></i> Create Date - `+stringshort(created_on,10,'')+`
