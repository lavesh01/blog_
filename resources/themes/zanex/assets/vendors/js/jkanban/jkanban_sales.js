...
(function () {
  this.jKanban = function () {
    ...
    var bname,business_email,business_name,designation,leadsrequired,enddate ;
    if (item.name !== undefined && item.name != '' && item.name !=  null  ) {
      bname = item.name;
    }

    if (item.business_email !== undefined && item.business_email != '' && item.business_email !=  null  ) {
      business_email = item.business_email;
    }
    if (item.business_name !== undefined && item.business_name != '' && item.business_name !=  null  ) {
      business_name = item.business_name;
    }
    if (item.designation !== undefined && item.designation != '' && item.designation !=  null  ) {
      designation = item.designation;
    }
    if (item.leadsrequired !== undefined && item.leadsrequired != '' && item.leadsrequired !=  null  ) {
      leadsrequired = item.leadsrequired;
    }
    if (item.enddate !== undefined && item.enddate != '' && item.enddate !=  null  ) {
    ...
    var strhtm =   ` <div class="card widget-content">
                                    <div class="widget-content-outer">
                                        <div class="widget-content-wrapper mb-1">
                                            <div class="widget-content-left">
                                                <div class="widget-heading"><i data-toggle="tooltip" data-title="Name" class="fa fa-user icon-gradient bg-sunny-morning" ></i> `+bname+`</div>
                                                <div class="widget-subheading"><i data-toggle="tooltip" data-title="Company" class="fa fa-ils icon-gradient bg-malibu-beach" ></i> `+ business_name +`</div>
                                                <div class="widget-subheading"><i data-toggle="tooltip" data-title="Designation" class="fa fa-address-card icon-gradient bg-ripe-malin" ></i>  `+ designation +`</div>
                                                <div class="widget-subheading"><i data-toggle="tooltip" data-title="Email" class="fa fa-at icon-gradient bg-night-fade" ></i>  `+ business_email +`</div>
                                            </div>
                                        </div>
                                        <div class="widget-progress-wrapper sub_profile">
                                            <div style="border: 1px solid #a9bceb;; "> 
                                            </div>
                                            <div class="progress-sub-label  mb-1">
                                                <div class="sub-label-left font-icon-lg" >
                                                <i data-toggle="tooltip" data-title="Lead Required" class="fa  fa-bar-chart icon-gradient bg-premium-dark" ></i>
                                                Leads :  `+leadsrequired+`
                                                </div>

                                                <div class="sub-label-right">
                                                   <div class="sub-label-right font-icon-lg" >
                                                    <i data-toggle="tooltip" data-title="End Date" class="fa fa-clock-o icon-gradient bg-premium-dark" ></i>
                                                    ETA :  `+enddate+`
                                                    </div>
                                                </div>
                                        ...
                                        <div class="widget-progress-wrapper sub_profile">
                                           ...
                                           `+strtag+`
                                            <div class="progress-sub-label  mb-1">
                                                <div class="sub-label-left font-icon-lg" ><i data-toggle="tooltip" data-title="Date Created" class="fa fa-clock-o icon-gradient bg-premium-dark" ></i> Create Date - `+stringshort(item.created_on,10,'')+`
                                                  <div class="sub-label-left font-icon-lg" ><i  data-toggle="tooltip" data-title="Reminder Date" class="fa fa-calendar icon-gradient bg-love-kiss"></i> Reminder`+stringshort(reminder,10,'')+`</div>
                                                </div>
      ...
      if (self.options.itemHandleOptions.enabled) {
          if ((self.options.itemHandleOptions.customHandler || undefined) === undefined) {
              ...
              result = strhtm + '<div class=\'item_handle ' + customCssHandler + '\'><i class=\'item_handle ' + customCssIconHandler + '\'></i></div><div>' + result + '</div>'
          } else {
