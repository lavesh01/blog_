  ...
  var aocolumnDefs =  [
                    {    
                        ...
                        "mRender": function (data, type, full) {
                           ...
                           if (full.group_id != '' && full.group_id != null && full.group_id !== undefined ) {
                             chked = "checked";   
                            }
                            return '<label><input type="checkbox"  title="Check enable this group" data-toggle="tooltip"  data-placement="top" class="click_enable"  value="'+data+'" '+chked+' > </label> ';
                        }
                      },
                      {    
                        "aTargets": [2],
...
function refresh_access_table(module1="agent"){
    ...
    enable_common_dataTable( 'Usergroupaccess/getGroup/' ,"#common_dataTable_usergroup",action,aocolumnDefs,"checkbox_datatable_check()",send_data);
}
...
$('.access_group').on('click', function () {
  ...
  if (current_datatable !=this_click )
  {
    ...
    enable_common_dataTable( 'Usergroupaccess/getGroup/' ,"#common_dataTable_usergroup",action,aocolumnDefs,"refresh_access_table()",send_data);
  }
