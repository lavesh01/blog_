  ...
  var aocolumnDefs =  [
                        ...
                        {   
                              ...
                              "mRender": function (data, type, full) {
                               var a = '<a  data-toggle="tooltip" data-title="View" href="'+site_url+"Edm/edmlistsuploadfiles/"+data + '"><i class="fa fa-eye icon-gradient bg-malibu-beach " aria-hidden="true"></i> </a>';
...
$("#upload_prospect_file").click(function (argument) {
   block_ajax_ui();
   var url =site_url + "Edm/upload_edm_list" ;
   ...
   $.ajax({
        ...
        success: function (data, status)
        {
          if (data.type == "success") {
            ...
            enable_common_dataTable( 'Edm/ajax_getAssetEmailList' ,"#edm_dataTable",action,aocolumnDefs);
          }
          else
          {
            Swal.fire({
