...
$(document).ready(function() {
    enable_common_dataTable( 'sales_ajax/getSalesPersonBoardItem' ,htmldatatable_id,action,aocolumnDefs,"init_page()");
} );
...
function draw_table(type="") {
 ...
 var action = [
  ...
  if (type=="") {
    dt_test = enable_common_dataTable( 'sales_ajax/getSalesPersonBoardItem' ,htmldatatable_id,action,aocolumnDefs);
