...
<head>
    ...
    <link href='https://supermag-templateify.blogspot.com/favicon.ico' rel='icon' type='image/x-icon' />
    <meta content='#1087FF' name='theme-color' />
    <link href='https://supermag-templateify.blogspot.com/' rel='canonical' />
    <meta content='SuperMag Blogger Template is a very powerful, fast, optimized and professional blogspot theme.'
        name='description' />
    <link
        href='https://lh3.googleusercontent.com/blogger_img_proxy/AAOd8MxmzvQjh8lohfDW__U6ni-GuZusLnM0BL2Swe5n2UmveSwuz0zq9tnfSVaQmlzSn8nzDYlO4gGoxQGzUvPWrrW2YJixxG89v2dqVyt3JsACC6buNA=w1600'
        rel='image_src' />
    <!-- Metadata for Open Graph protocol. See http://ogp.me/. -->
    <meta content='en' property='og:locale' />
    <meta content='website' property='og:type' />
    <meta content='SuperMag - Blogger Template' property='og:title' />
    <meta content='https://supermag-templateify.blogspot.com/' property='og:url' />
    <meta content='SuperMag Blogger Template is a very powerful, fast, optimized and professional blogspot theme.'
        property='og:description' />
    <meta content='SuperMag - Blogger Template' property='og:site_name' />
    <meta
        content='https://lh3.googleusercontent.com/blogger_img_proxy/AAOd8MxmzvQjh8lohfDW__U6ni-GuZusLnM0BL2Swe5n2UmveSwuz0zq9tnfSVaQmlzSn8nzDYlO4gGoxQGzUvPWrrW2YJixxG89v2dqVyt3JsACC6buNA=w1600'
        property='og:image' />
    <meta
        content='https://lh3.googleusercontent.com/blogger_img_proxy/AAOd8MxmzvQjh8lohfDW__U6ni-GuZusLnM0BL2Swe5n2UmveSwuz0zq9tnfSVaQmlzSn8nzDYlO4gGoxQGzUvPWrrW2YJixxG89v2dqVyt3JsACC6buNA=w1600'
        property='twitter:image' />
    <meta content='summary_large_image' name='twitter:card' />
    <meta content='SuperMag - Blogger Template' name='twitter:title' />
    <meta content='https://supermag-templateify.blogspot.com/' name='twitter:domain' />
    <meta content='SuperMag Blogger Template is a very powerful, fast, optimized and professional blogspot theme.'
        name='twitter:description' />
    <link rel="alternate" type="application/atom+xml" title="SuperMag - Blogger Template - Atom"
        href="https://supermag-templateify.blogspot.com/feeds/posts/default" />
    <link rel="alternate" type="application/rss+xml" title="SuperMag - Blogger Template - RSS"
        href="https://supermag-templateify.blogspot.com/feeds/posts/default?alt=rss" />
    <link rel="service.post" type="application/atom+xml" title="SuperMag - Blogger Template - Atom"
        href="https://www.blogger.com/feeds/3495801317983671086/posts/default" />
    <script type='application/ld+json'>
    {
        "@context": "http://schema.org",
        "@type": "WebSite",
        "name": "SuperMag - Blogger Template",
        "url": "https://supermag-templateify.blogspot.com/",
        "potentialAction": {
            "@type": "SearchAction",
            "target": "https://supermag-templateify.blogspot.com/search?q={search_term_string}",
...
-----------------------------------------------*/
    ...
    * {
    ...
    .entry-inner:hover .entry-image-wrap .entry-thumb {
    ...
    .entry-inner:hover .entry-image-wrap.is-video:after {
    ...
    #supermag-preview-main-nav {
        position: static;
        height: 58px;
        z-index: 10
    }

    #supermag-preview-main-nav .widget,
    #supermag-preview-main-nav .widget>.widget-title {
        display: none
    }

    #supermag-preview-main-nav .show-menu {
        display: block
    }

    #supermag-preview-main-nav ul#supermag-preview-main-nav-menu {
        display: flex;
        flex-wrap: wrap
    }

    #supermag-preview-main-nav ul>li {
        position: relative;
        padding: 0;
        margin: 0
    }

    #supermag-preview-main-nav-menu>li>a {
        position: relative;
        display: block;
        height: 58px;
        font-size: 14px;
    ...
    #supermag-preview-main-nav-menu>li:hover>a {
        color: var(--header-hover-color)
    }

    #supermag-preview-main-nav ul>li>ul,
    #supermag-preview-main-nav ul>li>.ul {
        position: absolute;
        float: left;
        left: 0;
    ...
    .rtl #supermag-preview-main-nav ul>li>ul,
    .rtl #supermag-preview-main-nav ul>li>.ul {
        left: auto;
        right: 0
    }

    #supermag-preview-main-nav ul>li>ul>li>ul {
        position: absolute;
        top: -5px;
        left: 100%;
        margin: 0
    ...
    .rtl #supermag-preview-main-nav ul>li>ul>li>ul {
        left: unset;
        right: 100%
    }

    .is-dark #supermag-preview-main-nav ul>li>ul,
    .is-dark #supermag-preview-main-nav ul>li>.ul {
        box-shadow: 0 5px 10px 0 rgba(0, 0, 0, 0.1)
    }

    #supermag-preview-main-nav-menu>li.has-sub>ul:before,
    #supermag-preview-main-nav-menu>li.has-sub>ul>li:first-child>ul:before,
    ...
    #supermag-preview-main-nav ul>li>ul>li {
        display: block;
        float: none;
        position: relative
    }

    .rtl #supermag-preview-main-nav ul>li>ul>li {
        float: none
    }

    #supermag-preview-main-nav ul>li>ul>li a {
        position: relative;
        display: block;
        font-size: 14px;
    ...
    #supermag-preview-main-nav ul>li>ul>li:hover>a {
        color: var(--submenu-hover-color)
    }

    #supermag-preview-main-nav ul>li.has-sub>a:after {
        content: '\f078';
        float: right;
        font-family: 'Font Awesome 5 Free';
        font-size: 9px;
    ...
    .rtl #supermag-preview-main-nav ul>li.has-sub>a:after {
        float: left;
        margin: -1px 4px 0 0
    }

    #supermag-preview-main-nav ul>li>ul>li.has-sub>a:after {
        content: '\f054';
        float: right;
        margin: 0
    }

    .rtl #supermag-preview-main-nav ul>li>ul>li.has-sub>a:after {
        content: '\f053'
    }

    #supermag-preview-main-nav ul ul,
    #supermag-preview-main-nav ul .ul {
        transition: visibility .1s ease, opacity .17s ease
    }

    #supermag-preview-main-nav ul>li:hover>ul,
    #supermag-preview-main-nav ul>li:hover>.ul,
    #supermag-preview-main-nav ul>li>ul>li:hover>ul {
        visibility: visible;
        opacity: 1;
        margin: 0
    }

    #supermag-preview-main-nav .mega-menu {
        position: static !important
    }

    #supermag-preview-main-nav .mega-menu>.ul {
        width: 100%;
        overflow: hidden;
    ...
    #supermag-preview-main-nav .mega-menu>.ul.no-items {
    ...
    .hide-supermag-preview-mobile-menu {
        position: relative;
        display: block;
        height: 36px;
        color: var(--header-color);
    ...
    .hide-supermag-preview-mobile-menu:before {
        content: '\f00d';
        font-family: 'Font Awesome 5 Free';
        font-weight: 900
    }

    .hide-supermag-preview-mobile-menu:hover {
        color: var(--header-hover-color)
    }
    ...
    .supermag-preview-mobile-menu>ul {
        margin: 0
    }

    .supermag-preview-mobile-menu .m-sub {
        display: none;
        padding: 0
    }

    .supermag-preview-mobile-menu ul li {
        position: relative;
        display: block;
        overflow: hidden;
        float: left;
    ...
    .supermag-preview-mobile-menu>ul li ul {
        overflow: hidden
    }

    .supermag-preview-mobile-menu ul li a {
    ...
    .supermag-preview-mobile-menu ul li.has-sub .submenu-toggle {
        position: absolute;
        top: 0;
        right: 0;
        width: 30px;
    ...
    .supermag-preview-mobile-menu ul li.has-sub li.has-sub .submenu-toggle {
        padding: 8px 0
    }

    .rtl .supermag-preview-mobile-menu ul li.has-sub .submenu-toggle {
        text-align: left;
        right: auto;
        left: 0
    }

    .supermag-preview-mobile-menu ul li.has-sub .submenu-toggle:after {
        content: '\f078';
        font-family: 'Font Awesome 5 Free';
        font-weight: 900;
        float: right;
    ...
    .rtl .supermag-preview-mobile-menu ul li.has-sub .submenu-toggle:after {
        float: left
    }

    .supermag-preview-mobile-menu ul li.has-sub.show>.submenu-toggle:after {
        content: '\f077'
    }

    .supermag-preview-mobile-menu ul li a:hover,
    .supermag-preview-mobile-menu ul li.has-sub.show>a,
    .supermag-preview-mobile-menu ul li.has-sub.show>.submenu-toggle {
        color: var(--mobilemenu-hover-color)
    }

    .supermag-preview-mobile-menu>ul>li>ul>li a {
        font-size: 14px;
        font-weight: 400;
        opacity: .9;
    ...
    .rtl .supermag-preview-mobile-menu>ul>li>ul>li a {
        padding: 8px 10px 8px 0
    }

    .supermag-preview-mobile-menu>ul>li>ul>li>ul>li>a {
        padding: 8px 0 8px 20px
    }

    .rtl .supermag-preview-mobile-menu>ul>li>ul>li>ul>li>a {
        padding: 8px 20px 8px 0
    }

    .supermag-preview-mobile-menu ul>li>.submenu-toggle:hover {
        color: var(--mobilemenu-hover-color)
    }
    ...
    .index-post .entry-author,
    .index-post .entry-time {
        display: flex
    }

    .index-post .entry-author .by,
    .index-post .author-name,
    .index-post .entry-time .on {
        margin: 0 4px 0 0
    }

    .rtl .index-post .entry-author .by,
    .rtl .index-post .author-name,
    .rtl .index-post .entry-time .on {
        margin: 0 0 0 4px
    }
    ...
    .item-post .entry-author,
    .item-post .entry-time {
        display: flex;
        align-items: center
    }

    .item-post .entry-author .by,
    .item-post .author-name,
    .item-post .entry-time .on {
        margin: 0 4px 0 0
    }

    .rtl .item-post .entry-author .by,
    .rtl .item-post .author-name,
    .rtl .item-post .entry-time .on {
        margin: 0 0 0 4px
    }
    ...
    html.is-dark .post-body pre,
    html.is-dark pre.code-box {
        background-color: rgba(155, 155, 155, 0.05)
    }
    ...
    ul.supermag-preview-share-links {
        display: flex;
        flex-wrap: wrap;
    ...
    .supermag-preview-share-links li {
        padding: 0 5px 0 0
    }

    .rtl .supermag-preview-share-links li {
        padding: 0 0 0 5px
    }

    .supermag-preview-share-links .share-icon {
        position: relative;
        display: flex;
        width: 38px;
        height: 36px;
    ...
    .rtl .supermag-preview-share-links .share-icon {
        margin: 5px 0 0 5px
    }

    .supermag-preview-share-links .share-icon:before,
    .supermag-preview-share-links .share-icon:after {
        content: '';
        height: 0;
        width: 0;
        position: absolute;
    ...
    .rtl .supermag-preview-share-links .share-icon:before {
        left: -12px;
        right: unset
    }

    .rtl .supermag-preview-share-links .share-icon:after {
        left: -10px;
        right: unset
    }
    ...
    .rtl .supermag-preview-share-links .share-icon:before,
    .rtl .supermag-preview-share-links .share-icon:after,
    .rtl .supermag-preview-share-links .share-icon i {
        transform: rotate3d(0, 1, 0, 180deg)
    }

    .supermag-preview-share-links li a {
        display: flex;
        width: 38px;
        height: 36px;
        font-size: 16px;
    ...
    .supermag-preview-share-links li.has-span a {
        width: auto;
        overflow: hidden;
        justify-content: space-between
    }

    .supermag-preview-share-links li.has-span a:before {
        display: flex;
        width: 36px;
        height: 100%;
    ...
    .supermag-preview-share-links li a span {
        display: inline-block;
        font-size: 14px;
        font-weight: 400;
        padding: 0 25px
    ...
    .supermag-preview-share-links li a:hover {
        opacity: .9
    }

    .supermag-preview-share-links .show-hid a {
        background-color: rgba(155, 155, 155, 0.08);
        font-size: 14px;
        color: rgba(155, 155, 155, 0.8)
    }

    .supermag-preview-share-links .show-hid a:before {
        content: '\f067';
        font-family: 'Font Awesome 5 Free';
        font-weight: 900
    }
    ...
    .supermag-preview-share-links li.reddit,
    .supermag-preview-share-links li.pinterest-p,
    .supermag-preview-share-links li.tumblr,
    .supermag-preview-share-links li.telegram {
        display: none
    }

    .show-hidden li.reddit,
    .show-hidden li.pinterest-p,
    .show-hidden li.tumblr,
    ...
    #supermag-preview-related-posts {
        display: none
    }
    ...
    .supermag-preview-related-content {
        float: left;
        width: 100%;
        margin: 0
    }

    .supermag-preview-related-content .loader {
        height: 200px
    }
    ...
    #blog-pager #supermag-preview-load-more-link {
        cursor: pointer
    }

    #blog-pager #supermag-preview-load-more-link:before {
        content: '\f067';
        display: inline-block;
        font-family: 'Font Awesome 5 Free';
        font-size: 11px;
    ...
    #blog-pager #supermag-preview-load-more-link:hover {
        background-color: var(--button-hover-bg);
        color: var(--button-hover-color)
    }
    ...
    .supermag-preview-blog-post-comments {
        display: none;
        float: left;
        width: 100%;
        padding: 0;
    ...
    .supermag-preview-blog-post-comments .fb_iframe_widget_fluid_desktop,
    .supermag-preview-blog-post-comments .fb_iframe_widget_fluid_desktop span,
    .supermag-preview-blog-post-comments .fb_iframe_widget_fluid_desktop iframe {
        float: left;
    ...
    #comments[data-embed='false'] p.comments-message,
    .no-comments p.comments-message.no-new-comments {
        margin: 0
    }
    ...
    .rtl #show-comment-form,
    .rtl .comments #top-continue a {
        float: right
    }
    ...
    .comment-form-visible .comments .comment-replybox-thread,
    .comment-form-visible .no-comments .comment-form {
        display: block
    }

    #custom-ads,
    #supermag-preview-post-footer-ads {
        position: relative;
        float: left;
        width: 100%;
        opacity: 0;
    ...
    #supermag-preview-new-before-ad #before-ad,
    #supermag-preview-new-after-ad #after-ad {
        float: none;
        display: block;
        margin: 0
    }

    #supermag-preview-new-before-ad #before-ad .widget,
    #supermag-preview-new-after-ad #after-ad .widget {
        margin: 0
    }
    ...
    .supermag-preview-widget-ready .list-style li {
        position: relative;
        display: block;
        font-size: 14px;
        color: var(--title-color);
    ...
    .supermag-preview-widget-ready .list-style li a {
        display: block;
        color: var(--title-color);
        padding: 5px 0
    }

    .supermag-preview-widget-ready .list-style li a.has-count {
        display: flex;
        justify-content: space-between
    }

    .supermag-preview-widget-ready .list-style li:first-child a {
        padding: 0 0 5px
    }

    .supermag-preview-widget-ready .list-style li:last-child a {
        padding: 5px 0 0
    }

    .supermag-preview-widget-ready .list-style li a:hover {
        color: var(--title-hover-color)
    }

    .supermag-preview-widget-ready .list-style li a span {
        display: inline-block;
        font-size: 12px;
        color: var(--meta-color);
        text-decoration: none;
    ...
    .rtl .supermag-preview-widget-ready .list-style li a span {
        margin: 1px 5px 0 0
    }

    .supermag-preview-widget-ready .text-list li {
        padding: 5px 0
    }

    .supermag-preview-widget-ready .text-list li:first-child {
        padding: 0 0 5px
    }

    .supermag-preview-widget-ready .text-list li:last-child {
        padding: 5px 0 0
    }
    ...
    #supermag-preview-about-section {
        position: relative;
        float: left;
        width: 100%;
        display: flex;
    ...
    #supermag-preview-about-section .Image {
        width: calc(100% - 325px);
        display: flex;
        flex-wrap: wrap;
        align-items: center;
    ...
    #supermag-preview-about-section .footer-logo {
        padding: 0 25px 0 0
    }

    .rtl #supermag-preview-about-section .footer-logo {
        padding: 0 0 0 25px
    }

    #supermag-preview-about-section .footer-logo img {
        display: block;
        max-height: 36px;
        margin: 0
    }

    #supermag-preview-about-section .Image .image-caption {
        font-size: 14px;
        color: var(--footer-text-color);
        margin: 0
    }

    #supermag-preview-about-section .Image .image-caption a {
        color: var(--footer-color)
    }

    #supermag-preview-about-section .Image .image-caption a:hover {
        color: var(--footer-hover-color)
    }

    #supermag-preview-about-section .LinkList {
        width: 300px;
        display: flex;
        align-items: center;
    ...
    .supermag-preview-about-section ul.social-icons {
        float: right
    }

    .rtl .supermag-preview-about-section ul.social-icons {
        float: left
    }

    .supermag-preview-about-section .social-icons li {
        float: left;
        margin: 0 0 0 10px
    }

    .rtl .supermag-preview-about-section .social-icons li {
        float: right;
        margin: 0 10px 0 0
    }

    .supermag-preview-about-section .social-icons li a {
        display: block;
        width: 36px;
        height: 36px;
        font-size: 16px;
    ...
    .supermag-preview-about-section .social-icons li a:hover {
        color: #fff
    }
    ...
    @media (max-width: 680px) {
        ...
        .supermag-preview-share-links li.has-span a span {
            display: none
        }
    ...
    //<![CDATA[
    var noThumbnail =
        "https://4.bp.blogspot.com/-eALXtf-Ljts/WrQYAbzcPUI/AAAAAAAABjY/vptx-N2H46oFbiCqbSe2JgVSlHhyl0MwQCK4BGAYYCw/s72-c/nth-ify.png",
        fixedMenu = true,
        fixedSidebar = true,
        darkMode = false,
        userDarkMode = true,
                        ...
                        <div class='topbar-social section' id='topbar-social' name='Topbar Icons'>
                            <div class='widget LinkList' data-version='2' id='LinkList106'>
                                <ul class='topbar-ul social-icons social'>
                                    <li class='facebook link-0'><a alt='facebook' class='facebook'
                                            href='https://www.facebook.com/templateify' rel='noopener noreferrer'
                                            target='_blank' title='facebook'></a></li>
                                    <li class='twitter link-1'><a alt='twitter' class='twitter'
                                            href='https://twitter.com/templateify' rel='noopener noreferrer'
                                            target='_blank' title='twitter'></a></li>
                                    <li class='youtube link-2'><a alt='youtube' class='youtube'
                                            href='https://www.youtube.com/c/Templateify_Blogger'
                                            rel='noopener noreferrer' target='_blank' title='youtube'></a></li>
                                    <li class='rss link-3'><a alt='rss' class='rss' href='https://www.templateify.com/'
                        ...
                        <div class='container row-x1'>
                            <div class='header-items'>
                                <div class='flex-left'>
                                    <div class='main-logo section' id='main-logo' name='Header Logo'>
                                        <div class='widget Header' data-version='2' id='Header1'>
                                            <a class='mobile-menu-toggle' href='javascript:;' role='button'
                                                title='Menu'></a>
                                            <a class='logo-img' href='https://supermag-templateify.blogspot.com/'>
                                                <img alt='SuperMag - Blogger Template' data-height='80' data-width='393'
                                                    src='//2.bp.blogspot.com/-DBaEVxDa5os/X77LSnjLC0I/AAAAAAAACxc/nJrW3wHgI88MfZ_HXBj-So4jwGohSMCEACK4BGAYYCw/s1600/supermag.png'
                                    ...
                                    <div class='supermag-preview-main-nav section' id='supermag-preview-main-nav'
                                        name='Header Menu'>
                                        <div class='widget LinkList' data-version='2' id='LinkList101'>
                                            <ul id='supermag-preview-main-nav-menu' role='menubar'>
                                                <li><a href='https://supermag-templateify.blogspot.com/'
                                                ...
                                                <li class='has-sub mega-menu'>
                                                    <a data-shortcode='{getMega} $label={recent}' href='#'
                                                        role='menuitem'>Mega Menu</a>
                                                </li>
                                ...
                                <div class='flex-right'>
                                    <div class='main-toggle-wrap'>
                                        <a class='main-toggle-style darkmode-toggle' href='javascript:;'
                                            role='button'></a>
                                        <a class='main-toggle-style show-search' href='javascript:;' role='button'
                                            title='Search'></a>
                                    </div>
                                </div>
                                <div id='main-search-wrap'>
                                    <div class='main-search'>
                                        <form action='https://supermag-templateify.blogspot.com/search'
