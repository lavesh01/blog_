...
class Grapes extends Admin_Controller   {
...
public function index($table_name="") {
    ...
    $data["title"] =  "Grapes";
    $data["js"] =  [       
        // "https://cdnjs.cloudflare.com/ajax/libs/grapesjs/0.21.3/grapes.min.js",
    ...
    $data["css"] = [ 
        // "https://cdnjs.cloudflare.com/ajax/libs/grapesjs/0.21.3/css/grapes.min.css",
    ...
    $this->load_view('blog/grapesjs', $data, 'operation/sidebar/sidebar');
}
